    ...
    return (
        <div className="py-4 px-8">
            <div className="flex items-center gap-3">
                ...
                <div className="flex gap-[6px] text-[12px] cursor:pointer text-[#71717a] ">
            ...
            <div className="header__search">
                <div className="flex items-center gap-[6px] px">
                    ...
                    <input className="box__input" type="text" placeholder="Search features, tutorial, etc." />
                </div>
            </div>
            <div className="header__actions">
                <div className="actions_notifications">
                    <svg height="24px" width="24px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        fill="currentColor" className="svg-notification-icon">
                ...
                <div className="actions_dropdown">
                    <svg height="22px" width="22px" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="svg-hamburger-icon">
                        <path strokeLinecap="round" strokeLinejoin="round"
