...
function Pagination() {
    return (
        <div className="flex my-4 items-center justify-center">
            <a href="#" className="px-4 py-2 mx-1 text-gray-500 capitalize bg-white rounded-md border border-gray-300 ">
            ...
            <a href="#" className="px-4 py-2 mx-1 text-gray-700 transition-colors duration-300 transform bg-white rounded-md   hover:bg-blue-500 -500 hover:text-white -200">
                <div className="flex items-center -mx-1">
                    <span className="mx-1">
                        Next
                    </span>
